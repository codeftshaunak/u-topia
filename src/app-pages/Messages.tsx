  ...
  announcements: [
    {
      ...
      content:
        "We are pleased to share our Q4 2024 performance report. Review our quarterly metrics, strategic initiatives, and roadmap for 2025.",
      date: "Dec 8, 2024",
      type: "announcement",
    ...
    },
    {
      ...
      content:
        "We are thrilled to announce $50M in Series B funding to accelerate our mission of building the bank of the future.",
      date: "Dec 5, 2024",
      type: "announcement",
  ...
  "u-topia-materials": [
    {
      ...
      content:
        "Everything you need to know as a U-topia shareholder. Includes governance, voting rights, and communication channels.",
      date: "Nov 15, 2024",
      type: "resource",
      link: "#",
    ...
    },
    {
      ...
      content:
        "Detailed breakdown of U-Coin utility, distribution, and ecosystem integration.",
      date: "Nov 10, 2024",
      type: "resource",
      link: "#",
    ...
    },
    {
      ...
      content:
        "Official U-topia logos, colors, and brand usage guidelines for shareholders and partners.",
      date: "Oct 28, 2024",
      type: "resource",
      link: "#",
  ...
  "events-calendar": [
    {
      ...
      content:
        "Live Q&A with the leadership team. Submit your questions in advance.",
    ...
    },
    {
      ...
      content:
        "Virtual annual meeting with voting on key proposals and board updates.",
    ...
    <div className="h-[calc(100vh-2rem)] flex">
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="p-4 border-b bg-card">
          <div className="flex items-center gap-3">
            {currentChannel && (
              <currentChannel.icon className="h-5 w-5 text-muted-foreground" />
            )}
            <div>
